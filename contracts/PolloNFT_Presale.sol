...
contract PolloNFT is ERC721, Operator {

    constructor() public ERC721("PolloNFT Presale", "PNP") {
    }
    ...
    function mint(uint256 tokenId, address _to, string calldata _tokenURI) external onlyOperator {
        _mint(_to, tokenId);
        _setTokenURI(tokenId, _tokenURI);
    }
